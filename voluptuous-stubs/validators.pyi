...
def isTrue(msg=None, clsoverride: _Any=None) -> Callable[[_Any], bool]: ...

def IsFalse(msg=None, clsoverride: _Any=None) -> Callable[[_Any], bool]: ...

def Boolean(msg=None, clsoverride: _Any=None) -> Callable[[_Any], bool]: ...
